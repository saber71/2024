...
export class WindowIpc {
   ...
   * @param id - 窗口的ID。
   */
  @IpcHandler("window:maximize") windowMaximize(id: number) {
   ...
   * @param id - 窗口的ID。
   */
  @IpcHandler("window:unmaximize") windowUnmaximize(id: number) {
   ...
   * @param id - 窗口的ID。
   */
  @IpcHandler("window:minimize") windowMinimize(id: number) {
   ...
   * @param id - 窗口的ID。
   */
  @IpcHandler("window:close") windowClose(id: number) {
   ...
   */
  @IpcHandler("window:isMaximized") getWindowIsMaximized(id: number) {
